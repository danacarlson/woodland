...
woodlandScene.scene = (function() {  
  ...
  sounds = {
    ...
    'init' : function() {
      ...
      createjs.Sound.registerSound("../sounds/rooster.mp3", "rooster");
      createjs.Sound.registerSound("../sounds/birds.mp3", "birds");
      createjs.Sound.registerSound("../sounds/rain.mp3", "rain");
      createjs.Sound.registerSound("../sounds/cheering.mp3", "cheer"); 
     },
  ...
  backgrounds = { 
    ...
    'setStageBackgroundColor' : function () {
     ...
     'setBackgroundImage' : function() { 
       stage.BackgroundImage = new createjs.Bitmap('../images/woodland-bg-8.png');
  ...
  shapes = {
    ...
    'drawSign' : function() {
      stageElements.sign = new createjs.Bitmap('../images/sign-sm.png');
